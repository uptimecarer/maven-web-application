...
<h2 align="center">today i am learning declrative pipeline1 by using groovy language. and use private key with ssh agent and use poll SCM and Discard Bills ans mail also....</h2>
